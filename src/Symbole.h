...
class Symbole {
public:
	enum categorieSymbole { MOTCLE, VARIABLE, ENTIER, INDEFINI, FINDEFICHIER, CHAINE, ERREUR };
	...
	bool operator == (string ch) ; // pour tester l'égalité entre le symbole et une chaîne sans passer par un accesseur
